...
onPageLoad('mypage#direct_messages', function () {
  ...
  console.log(tabs); // tabs.slice(-1)[0].classList.add('inactive');
  // tables.slice(-1)[0].last.classList.add('inactive');
...
/******/ });
//# sourceMappingURL=home_mypage-afd62b1bfd45fffad4e9.js.map