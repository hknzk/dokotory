...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "cc1e3a7c1b98bac3469f";
...
onPageLoad('articles#new', function () {
  ...
  map.addListener('click', function (e) {
    ...
    geocoder.geocode({
      ...
      document.getElementById('article_prefecture').value = getPrefectureName(results).toString();
...
/******/ });
//# sourceMappingURL=google_map-cc1e3a7c1b98bac3469f.js.map