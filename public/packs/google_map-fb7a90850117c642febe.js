...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "fb7a90850117c642febe";
...
var isEnabled; // new edit

var locationSelector; // new edit
...
function selectPrefectureManually() {
  lat.readOnly = true;
  lng.readOnly = true;
  lat.value = null;
  lng.value = null;
...
onPageLoad('articles#new', function () {
  ...
  isEnabled = document.getElementById('map_is_enabled'); // new edit

  locationSelector = document.getElementById('map_location'); // new edit
...
/******/ });
//# sourceMappingURL=google_map-fb7a90850117c642febe.js.map