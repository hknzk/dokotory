...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "bd343dc59a075ab8da2e";
...
onPageLoad(['articles#new', 'articles#edit'], function () {
  ...
  uploadArea.addEventListener('drop', function (e) {
    e.preventDefault();
    e.target.style.backgroundColor = 'pink';
    fileField.files.length += 1;
    fileFiled.files[fileField.files.length] = e.dataTransfer.files[0]; // fileField.files = e.dataTransfer.files;
    // fileField.files['0'] = e.dataTransfer.files['0'];
...
/******/ });
//# sourceMappingURL=article_board-bd343dc59a075ab8da2e.js.map