...
function rel() {
  if (window.name != "any") {
    document.querySelector('.contents .main').textContent = 'しばらくおまちください。'; // document.body.textContent = 'しばらくおまちください。'
...
onPageLoad('articles#new', function () {
  ...
  mapSwicth.addEventListener('change', function (e) {
    isMapEnabled.click();
  });
...
onPageLoad(['articles#show', 'articles#visitor'], function () {
...
/******/ });
//# sourceMappingURL=google_map-9cea7302b8aadba65b2d.js.map