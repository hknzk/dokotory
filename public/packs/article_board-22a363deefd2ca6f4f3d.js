...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "22a363deefd2ca6f4f3d";
...
onPageLoad(['articles#new', 'articles#edit'], function () {
  ...
  uploadArea.addEventListener('drop', function (e) {
    ...
    fileField.files = dt.files; // console.log(dt.files);
...
onPageLoad('home#top', function () {
  ...
  loadArticle.addEventListener('ajax:success', function () {
    // gon.watch('sample');
    console.log(gon.watch.sample);
  });
...
/******/ });
//# sourceMappingURL=article_board-22a363deefd2ca6f4f3d.js.map