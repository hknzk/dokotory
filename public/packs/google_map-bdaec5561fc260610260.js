...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "bdaec5561fc260610260";
...
onPageLoad('articles#new', function () {
  ...
  locationSelector.addEventListener('change', function (e) {
    console.log(e.target.options[selectedIndex]); // var selectedLocation =
    // map.setOptions({
    //   center: tokyo,
    // });
  });
...
/******/ });
//# sourceMappingURL=google_map-bdaec5561fc260610260.js.map