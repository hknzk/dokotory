...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "f3569281d81c83c729ca";
...
onPageLoad(['articles#new', 'articles#edit'], function () {
  ...
  uploadArea.addEventListener('drop', function (e) {
    e.preventDefault();
    e.target.style.backgroundColor = 'pink'; // console.log(e.dataTransfer.files);
    // console.log(typeof e.dataTransfer.files[0]);
    // // console.log(fileField.files.length);
    // // console.log(fileField.files[fileField.files.length]);
    // console.log(typeof fileField.files);
    // console.log(fileField.files);

    fileField.files = e.dataTransfer.files;
    setPreviewImage(e.dataTransfer.files); // console.log(fileField.files);
  });
});
...
/******/ });
//# sourceMappingURL=article_board-f3569281d81c83c729ca.js.map