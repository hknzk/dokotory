...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "8807a040e38e590fd5c6";
...
onPageLoad(['articles#new', 'articles#edit'], function () {
  ...
  uploadArea.addEventListener('drop', function (e) {
    ...
    if (dt.files.length >= 3) {
      uploadArea.firstElementChild.value = 'これ以上画像を送付できません。';
    }
  });
  clearImagesButton.addEventListener('click', function () {
    ...
    console.log(dt.items);
    setPreviewImage(fileField.files);
    uploadArea.firstElementChild.value = '送付したい画像を3枚までドラッグ&ドロップ';
  });
});
...
/******/ });
//# sourceMappingURL=article_board-8807a040e38e590fd5c6.js.map