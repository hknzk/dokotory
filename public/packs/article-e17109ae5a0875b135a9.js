...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "e17109ae5a0875b135a9";
...
/******/ 	return hotCreateRequire("./app/javascript/packs/article.js")(__webpack_require__.s = "./app/javascript/packs/article.js");
/******/ })
/************************************************************************/
/******/ ({
...
onPageLoad(['articles#new', 'articles#edit'], function () {
  ...
  dragArea.addEventListener('drop', function (e) {
    ...
    if (dt.files.length >= 3) {
      dragArea.textContent = 'これ以上画像を送付できません。';
    }
  });
  clearImagesButton.addEventListener('click', function () {
    ...
    fileField.files = dt.files;
    setPreviewImage(fileField.files);
    dragArea.textContent = '送付したい画像を3枚までドラッグ&ドロップ';
  });
});
onPageLoad('articles#show', function () {
  var fileField = document.getElementById('message_image');
  var dragArea = document.getElementById('dragArea');
  var dt = new DataTransfer();
  var articleMainImg = document.querySelector('.main_img');
  var articleSubImgs = document.querySelectorAll('.sub_img');
  var clearMessageImagesButton = document.getElementById('clearMessageImagesButton');
  ...
  fileField.addEventListener('change', function (e) {
    ...
    if (e.target.files.length > 0) {
      clearMessageImagesButton.style.display = 'inline-block';
    }
  });
  dragArea.addEventListener('dragover', function (e) {
  ...
  clearMessageImagesButton.addEventListener('click', function () {
    dt.clearData();
    fileField.files = dt.files;
    setPreviewImage(fileField.files);
    clearMessageImagesButton.style.display = 'none';
  });
...
/******/ });
//# sourceMappingURL=article-e17109ae5a0875b135a9.js.map