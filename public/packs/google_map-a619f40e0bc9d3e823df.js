...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "a619f40e0bc9d3e823df";
...
onPageLoad('articles#new', function () {
  ...
  var target = document.getElementById('mapTarget');
  var prefectureSelector = document.getElementById('article_prefecture'); //new edit

  var substitute = document.getElementById('substitute_prefecture'); //new edit

  var map;
  var marker;
  var geocorder; //new, edit v

  var prefectures = [//new, edit v
  ...
  map = new google.maps.Map(target, {}); // new edit show

  if (isEnabled.checked) {
    //mapフォームの有効無効切り替え(デフォルト) //new edit
  ...
  isEnabled.addEventListener('change', function () {
    //mapフォームの有効無効切り替え(選択した時) //new edit
    if (isEnabled.checked) {
      substitute.style.display = 'inline-block';
      locationSelector.disabled = false;
      prefectureSelector.hidden = true;
...
/******/ });
//# sourceMappingURL=google_map-a619f40e0bc9d3e823df.js.map