...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "f71047bce09f70f3efb2";
...
onPageLoad('articles#new', function () {
  ...
  var locationSelecter = document.getElementById('map_location');
  ...
  locationSelecter.addEventListener('change', function () {
    console.log(mapLocationSelect); // map.setOptions({
    //   center: tokyo,
    // });
  });
...
/******/ });
//# sourceMappingURL=google_map-f71047bce09f70f3efb2.js.map