...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "ef5fb7ca8c15e2d8661e";
...
onPageLoad('articles#new', function () {
  ...
  console.log(document.getElementById('map_is_enabled')); // var latLng = {
  ...
  map.addListener('click', function (e) {
    ...
    }); // latLng.lat.value = e.latLng.lat().toFixed(6);
    // latLng.lng.value = e.latLng.lng().toFixed(6);
  });
});
...
/******/ });
//# sourceMappingURL=google_map-ef5fb7ca8c15e2d8661e.js.map