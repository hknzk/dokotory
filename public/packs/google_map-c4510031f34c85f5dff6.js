...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "c4510031f34c85f5dff6";
...
onPageLoad('articles#map', function () {
  ...
  console.log(prefectureButtons);
  prefectureButtons.forEach(function (button) {
    button.addEventListener('click', function () {
      // console.log(button.getAttribute('data-prefecture'));
      mapCenterSelector.value = button.getAttribute('data-prefecture');
      search.click();
    });
  });
});
...
/******/ });
//# sourceMappingURL=google_map-c4510031f34c85f5dff6.js.map