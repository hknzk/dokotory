...
onPageLoad('mypage#direct_messages', function () {
  ...
  tabs.last.classList.add('inactive');
  tables.last.classList.add('inactive');
  tabs.forEach(function (tab, index) {
    tab.addEventListener('click', function (e) {
      console.log(tab);
      console.log(index); // tabs.forEach(tb=>{
      //   tb.classList.add('inactive');
      // });
      // tables.forEach(tbl=>{
      //   tbl.classList.add('inactive');
      // });
...
/******/ });
//# sourceMappingURL=home_mypage-f7b3db7eef66fd706f92.js.map