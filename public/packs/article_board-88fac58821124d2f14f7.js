...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "88fac58821124d2f14f7";
...
onPageLoad(['articles#new', 'articles#edit'], function () {
  ...
  uploadArea.addEventListener('drop', function (e) {
    e.preventDefault();
    e.target.style.backgroundColor = 'pink';
    fileField.files = e.dataTransfer.files; // selectedFiles[selectedFiles.size - 1] = e.dataTransfer.files[0];
    // fileField.files = selectedFiles;
...
/******/ });
//# sourceMappingURL=article_board-88fac58821124d2f14f7.js.map