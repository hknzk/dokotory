...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "9799af32887e5b0f7183";
...
onPageLoad(['articles#new', 'articles#edit'], function () {
  ...
  dragArea.addEventListener('drop', function (e) {
    ...
    e.preventDefault();
    e.target.style.backgroundColor = 'rgb(231, 231, 231)';
    clearImagesButton.display = 'inline-block';
  ...
  clearImagesButton.addEventListener('click', function () {
    clearImagesButton.display = 'none';
    dt.clearData();
    fileField.files = dt.files;
    setPreviewImage(fileField.files);
...
/******/ });
//# sourceMappingURL=article-9799af32887e5b0f7183.js.map