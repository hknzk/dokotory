...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "1e6cb72de4bc11c6b624";
...
onPageLoad(['articles#new', 'articles#edit'], function () {
  ...
  uploadArea.addEventListener('drop', function (e) {
    ...
    if (dt.files.length >= 3) {
      uploadArea.firstElement.textContent = 'これ以上画像を送付できません。';
    }
  });
  clearImagesButton.addEventListener('click', function () {
    ...
    console.log(dt.items);
    setPreviewImage(fileField.files);
    uploadArea.firstElement.textContent = '送付したい画像を3枚までドラッグ&ドロップ';
  });
});
...
/******/ });
//# sourceMappingURL=article_board-1e6cb72de4bc11c6b624.js.map