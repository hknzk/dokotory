...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "5eb215bd85a006619da0";
...
onPageLoad(['articles#new', 'articles#edit'], function () {
  ...
  fileField.addEventListener('change', function (e) {
    setPreviewImage(e.target.files); // document.querySelectorAll('.previewImage').forEach(i => {
    //   i.parentNode.removeChild(i);
    // });
    //
  ...
  uploadArea.addEventListener('drop', function (e) {
    e.preventDefault();
    e.target.style.backgroundColor = 'pink';
    selectedFiles.push(e.dataTransfer.files[0]); // console.log(e.dataTransfer.files);

    console.log(selectedFiles);
    fileField.files = selectedFiles; // fileField.files = e.dataTransfer.files;
    // console.log(fileField.files);
    // console.log(Object.keys(fileField.files).length);
    // console.log(selectedFiles);

    setPreviewImage(e.dataTransfer.files);
  });
});
...
/******/ });
//# sourceMappingURL=article_board-5eb215bd85a006619da0.js.map