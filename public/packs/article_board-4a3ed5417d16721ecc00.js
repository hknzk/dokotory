...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "4a3ed5417d16721ecc00";
...
onPageLoad(['articles#new', 'articles#adit'], function () {
  var fileField = document.getElementById('article_images');
  fileField.addEventListener('change', function (e) {
    var files = e.target.files;
    console.log(Object.keys(files)); // Object.keys(files).forEach((file)=>{
    //   console.log(file);
    // });
...
/******/ });
//# sourceMappingURL=article_board-4a3ed5417d16721ecc00.js.map