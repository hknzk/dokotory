...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "9d4a0d5c7f52c6b0de2c";
...
onPageLoad('articles#new', function () {
  ...
  console.log(prefectures.indexOf('岩手県'));
  var tokyo = {
    lat: 35.681167,
    lng: 139.767052
  };
  ...
  map.addListener('click', function (e) {
    ...
    geocoder.geocode({
      ...
      document.getElementById('article_prefecture').options[1].selected = true;
...
/******/ });
//# sourceMappingURL=google_map-9d4a0d5c7f52c6b0de2c.js.map